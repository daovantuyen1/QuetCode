...
namespace RMSExternalApi.Businesses
{
    public class RMSAccountBusiness
    {
        ...
        public IE_C_ACCOUNT GetAccountInforFromCurJWT()
        {
            ...
            string mail = Encode.Decrypt(tokenJWT.Payload.ToList()[2].Value.ToString(), Constant.KEY_ENCODE);
            string phone = Encode.Decrypt(tokenJWT.Payload.ToList()[3].Value.ToString(), Constant.KEY_ENCODE);
